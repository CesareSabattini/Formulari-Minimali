...
To derive the partition function for a diatomic gas confined in an infinite potential ell, one can follow
an akin procedure to the monoatomic case, but considering that the rotational degree implies another energy term:
...
\begin{center}
    \begin{tabular}{|c|c|c|}
        ...
        \hline
        Exponential Integral & $\int_{0}^{\infty} e^{-ax} \, dx$                                  & $\frac{1}{a}$                            \\
        \hline
        ...
        \hline
        Fresnel Integrals    & $\int_{0}^{\infty} \cos(x^2) \, dx$                                & $\sqrt{\frac{\pi}{2}}$                   \\
        \hline
                             & $\int_{0}^{\infty} \sin(x^2) \, dx$                                & $\sqrt{\frac{\pi}{2}}$                   \\
        \hline
    \end{tabular}
\end{center}
